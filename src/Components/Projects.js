      ...
      <Card>
        <Card.Header>
          ...
          <p className="text-justify">
            ...
            <b>useState</b> and <b>useEffect</b> to manage the component's state
            and fetch the data from the API respectively. It uses{" "}
            <b>React Bootstrap</b> library to create a visually appealing layout
            and display the data in a <b>Toast</b> component. It also uses a{" "}
            <b>ternary operator</b> inside the <b>map</b> function to check if
            the repository's description is not null before rendering the
            repository, this way I render only the repositories that I wrote a
            description for. And it also uses a ternary operator to check if the
            component is still loading data from the API or not.
          </p>
